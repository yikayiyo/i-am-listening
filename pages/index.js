...
export default function Home() {
  ...
  return (
    <div>
      ...
      <main className='main md:grid md:grid-cols-[35%,35%] justify-center'>
        <section className='current-playing relative md:px-10 m-5 mt-10 sm:mx-auto rounded-3xl first-letter:shadow shadow-blue-500/40 hover:shadow-indigo-500/40'>
          <div className='album-wrapper md:h-full md:px-10 rounded-3xl backdrop-blur bg-black/60'>
            <NowPlaying {...data} />
          </div>
          <div
        ...
        {tracks && tracks?.data?.tracks && (
          <section className='top-tracks relative min-w-[20rem] max-w-lg md:overflow-auto m-5 mt-10 pb-10 rounded sm:mx-auto text-white text-xl backdrop-blur bg-black/60'>
